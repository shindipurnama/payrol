            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <!-- <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="{{ asset('asset/media/avatars/300-1.jpg') }}" alt="user">
                    </div> -->
                    <div class="d-flex align-items-center cursor-pointer btn btn-muted btn-active-light btn-active-color-primary h-30px h-md-40px px-3 skeleton skeleton-button" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" id="btnDropdown">
